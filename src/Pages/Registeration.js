    ...
    <div className="p-8 mt-9 ">
        ...
        <form className="max-w-xl mx-auto">
            ...
            <div className="my-5 flex flex-col md:flex-row md:space-x-2 w-full space-y-2 md:space-y-0">
                <button className="p-2  w-full bg-yellow-600 hover:bg-yellow-700 text-center text-white font-semibold drop-shadow-lg" type="submit"> Register</button>
                <button className="p-2  w-full border-2 bg-transparent hover:bg-yellow-600 hover:text-white font-semibold drop-shadow-lg" type="submit"> Login</button>
            </div>
</form>
        </div>
    </div>

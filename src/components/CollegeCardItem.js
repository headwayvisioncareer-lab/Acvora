...
const CollegeCardItem = ({item}) => {
  return (
    <>
      <div  className="bg-black/50 w-[17rem] sm:w-[22rem] md:w-[16rem] lg:w-[22rem] md:mx-2 lg:mx-0 h-[9rem] md:h-[9.3rem] lg:h-[10rem]   my-10 border-solid border-t-2 border-black relative">

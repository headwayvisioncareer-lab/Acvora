...
const PlaceCardItem = ({item}) => {
  return (
    <>
      <div  className="bg-black/40 w-[17rem] sm:w-[22rem] md:w-[16rem] lg:w-[22rem] md:mx-2 lg:mx-0 h-[7rem] md:h-[8rem] lg:h-[8rem]   my-10 border-solid border-t-2 border-black relative">
